        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              NextLevel<br />
              <span className="hero-title-gradient">Articles</span>
            </h1>

            <div className="main" style={{ padding: "40px 0" }}>
              <h3 className={styles.newsTitle} style={{ marginBottom: "20px" }}>
              ...
              <h3 className={styles.newsTitle} style={{ marginTop: "40px", marginBottom: "20px" }}>
                Une remontée légendaire
              </h3>

              <p className="hero-description">
                Mais dans une dernière manche incroyable, les Neon Vipers ont
                renversé la situation. Portés par la jeune star Akiro, they have
